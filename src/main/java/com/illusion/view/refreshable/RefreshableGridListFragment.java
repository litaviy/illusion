...
import com.illusion.view.list.GridListFragment;

/**
 * Created by numezmat on 28.07.16.
 */
public abstract class RefreshableGridListFragment<
        Adapter extends RecyclerView.Adapter,
        Presenter extends RefreshableListPresenter> extends GridListFragment<Adapter> {
